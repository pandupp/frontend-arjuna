...
// Template untuk invoice baru, sekarang dengan DP
...
watchEffect(() => {
  if (props.isOpen) {
    if (isEditMode.value) {
      ...
      // Pastikan properti yang mungkin tidak ada memiliki nilai default
...
const sisaTagihan = computed(() => grandTotal.value - (newInvoice.value.dp || 0)); // Hitung sisa tagihan
...
<style>
/* Kustomisasi tampilan Vue Select agar menyatu dengan desain */
:root {
