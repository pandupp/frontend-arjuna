  ...
  <div class="relative flex h-screen bg-gray-50 text-gray-900 font-sans">
    ...
    >
      ...
      <div class="p-4 border-t border-gray-100 flex-shrink-0">
        <button class="w-full bg-[#BF202F] hover:bg-[#a11a27] text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 shadow-md">
          Logout
        </button>
      </div>
    </aside>
